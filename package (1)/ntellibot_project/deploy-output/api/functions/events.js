...
function categorizeEvent(title) {
    ...
    if (lowerTitle.includes('health') || lowerTitle.includes('virus') || lowerTitle.includes('pandemic') || 
        ...
        lowerTitle.includes('flu') || lowerTitle.includes('infection')) return 'health';
    if (lowerTitle.includes('military') || lowerTitle.includes('attack') || lowerTitle.includes('war') || 
        lowerTitle.includes('strike') || lowerTitle.includes('combat') || lowerTitle.includes('troop') ||
        lowerTitle.includes('invasion') || lowerTitle.includes('bomb') || lowerTitle.includes('air strike')) return 'conflict';
    if (lowerTitle.includes('econom') || lowerTitle.includes('trade') || lowerTitle.includes('market') || 
        lowerTitle.includes('inflation') || lowerTitle.includes('recession') || lowerTitle.includes('financial') ||
        lowerTitle.includes('stock') || lowerTitle.includes('oil') || lowerTitle.includes('gas') ||
        lowerTitle.includes('price') || lowerTitle.includes(' sanctions')) return 'economic';
    if (lowerTitle.includes('political') || lowerTitle.includes('election') || lowerTitle.includes('government') || 
        lowerTitle.includes('protest') || lowerTitle.includes('diplomat') || lowerTitle.includes('president') ||
        lowerTitle.includes('minister') || lowerTitle.includes('parliament') || lowerTitle.includes('vote')) return 'political';
    if (lowerTitle.includes('terror') || lowerTitle.includes('hostage') || lowerTitle.includes('bomb') || 
        lowerTitle.includes('explosion') || lowerTitle.includes('suicide') || lowerTitle.includes('militant') ||
        lowerTitle.includes('isis') || lowerTitle.includes('al qaeda')) return 'security';
    if (lowerTitle.includes('climate') || lowerTitle.includes('environment') || lowerTitle.includes('disaster') || 
        ...
        lowerTitle.includes('storm') || lowerTitle.includes('wildfire') || lowerTitle.includes('drought')) return 'environmental';
    return 'geopolitical';
}

function estimateSeverity(title) {
    const lowerTitle = title.toLowerCase();
    if (lowerTitle.includes('critical') || lowerTitle.includes('emergency') || lowerTitle.includes('crisis') || 
        lowerTitle.includes('massacre') || lowerTitle.includes('genocide') || lowerTitle.includes('apocalypse') ||
        lowerTitle.includes('major disaster') || lowerTitle.includes('catastroph')) return 'critical';
    if (lowerTitle.includes('attack') || lowerTitle.includes('death') || lowerTitle.includes('disaster') || 
        lowerTitle.includes('killed') || lowerTitle.includes('casualties') || lowerTitle.includes('murder') ||
        lowerTitle.includes('shooting') || lowerTitle.includes('mass shooting') || lowerTitle.includes('assassinat')) return 'high';
    if (lowerTitle.includes('tension') || lowerTitle.includes('conflict') || lowerTitle.includes('threat') || 
        lowerTitle.includes('war') || lowerTitle.includes('escalation') || lowerTitle.includes('crisis') ||
        lowerTitle.includes('warning') || lowerTitle.includes('alert')) return 'medium';
    return 'low';
}
...
exports.handler = async (event, context) => {
    try {
        ...
        // PRIMARY SOURCE: GDELT API - Primary real-time event source
        eventPromises.push(
            axios.get('https://api.gdeltproject.org/api/v2/doc/doc', {
                ...
                console.log('GDELT API failed:', err.message);
                return { error: 'GDELT failed', fallback: [] };
            })
        );
